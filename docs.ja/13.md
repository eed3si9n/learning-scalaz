...
興味深い事に、`ToTreeOps` も全てのデータ型を <a href="https://github.com/scalaz/scalaz/blob/scalaz-seven/core/src/main/scala/scalaz/syntax/TreeOps.scala"><code>TreeOps[A]</code></a> に変換して 2つのメソッドを注入する:
